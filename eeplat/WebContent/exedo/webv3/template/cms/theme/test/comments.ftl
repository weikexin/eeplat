...
<p>您现在是以 ${get_user_info().userinfo.user_nicename} 的身份登录,<a href="http://127.0.0.1:8080/yiyi/exedo/webv3/template/cms/theme/test/index.ftl?action=logoff" title="Log out of this account"> 点击退出系统 &raquo;</a></p>
