...
<div class="sidebar2">
            ...
            <li>
                <h2>功能</h2>
                    ...
                    <#if is_userlogin()>
                    	 <li><a href="http://127.0.0.1:8080/yiyi/exedo/webv3/template/cms/theme/test/index.ftl?action=logoff">登出</a></li>
                  	<#else>       
                    	<li><a href="http://localhost:8080/yiyi/exedo/webv3/template/cms/login.ftl">登录</a></li>
                    </#if>  
                   </ul>
            </li>
   </ul> 
