...
	<img src="<%=request.getContextPath()%>/exedo/webv3/images/main/formHeader/user.png"/>
	<img src="<%=request.getContextPath()%>/exedo/webv3/images/main/formHeader/forward_all.png" title="查看消息"/>
	<img src="<%=request.getContextPath()%>/exedo/webv3/images/main/formHeader/color.png"/>
	<img src="<%=request.getContextPath()%>/exedo/webv3/images/main/formHeader/help.png" title="帮助"/>
	<img src="<%=request.getContextPath()%>/exedo/webv3/images/main/formHeader/stop.png" title="退出"/>
	<div class="themeLabel">
		<img value="_lan" src="<%=request.getContextPath()%>/exedo/webv3/images/main/formHeader/lan.gif"/>
		<img value="_lan" src="<%=request.getContextPath()%>/exedo/webv3/images/main/formHeader/qianlv.gif"/>
		<img value="_lan" src="<%=request.getContextPath()%>/exedo/webv3/images/main/formHeader/zi.gif"/>
		<img value="_lan" src="<%=request.getContextPath()%>/exedo/webv3/images/main/formHeader/shenlv.gif"/>
		<img value="_lan" src="<%=request.getContextPath()%>/exedo/webv3/images/main/formHeader/hong.gif"/>
