...
		window.location.href="msfldg/logoff.jsp";
...
<div algin="left" id='logoPic' style='z-index:1; height: 0; left: 0px; position: absolute; top: 1px; width: 0;'><img name='logoImg' width="232" height="37" src='<%=request.getContextPath()%>/msfldg/images/msfl_logo.jpg' border='0'></div> 
<div algin="left" style='z-index:1; left: 250px; position: absolute; top: 5px; width: 250px;'><p style="font-size: 22px;color: #91b3cc;font-weight: bold;"> 专业创新 合规高效</p></div>
