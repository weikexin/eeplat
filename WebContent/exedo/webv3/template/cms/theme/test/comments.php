...
<?php if ($comments) : ?>
	...
	<?php foreach ($comments as $comment) : ?>
		...
		<li <?php echo $oddcomment; ?>id="comment-<?php comment_ID() ?>">
			<div class="gravatar"><a href="<?php comment_author_url(); ?>" target="_blank"><?php if(function_exists("get_avatar")) echo get_avatar( get_comment_author_email(), '48', 'http://en.gravatar.com/userimage/3244064/abe7b8020c8fc8cc9b009469b5c159fc.jpeg' ); ?></a>
