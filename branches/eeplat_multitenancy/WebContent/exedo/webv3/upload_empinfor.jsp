...
<%
	...
	try{
		...
		System.out.println("emp_uid============" + emp_name);
		File empFile = new File(DOGlobals.UPLOAD_TEMP +  fileType + "/" + emp_name);
		empFile.mkdir();
	...
	name = name.substring(name.lastIndexOf("\\")+1);
		...
		fileName = fileType + "/" + emp_name + "/" + name;
