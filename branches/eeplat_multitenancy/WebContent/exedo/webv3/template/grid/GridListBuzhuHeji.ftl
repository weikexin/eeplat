...
<form  method='post' id='a${model.objUid}' name ='a${model.objUid}'>
	...
	<table id='g${model.objUid}' class='tablesorter' border="0" cellpadding="1" cellspacing="1" >
	   ...
	   <#list data as ins>
			...
			<#list model.normalGridFormLinks as item> 
		            <td  <#if item.noWrapValue>nowrap='nowrap'</#if> <#compress> <@JudgeAlign item/></#compress> >   <#if '${dataBind(ins,item)}' ==''> <#if item.htmlValue?exists>${item.htmlValue}</#if><#if item_index+1==3> <#assign totalmoney=totalmoney?double+item.htmlValue?number/>  </#if></#if> </td> 
			</#list>
			</tr>
	     </#list>
		...
		<tfoot>
			<tr>
				<td align='center' colspan='3'><span style='color:red;'>金额合计</span></td>
				<td align='left'><span style='color:red'>共&nbsp;${totalmoney}&nbsp;元</span></td>
				<td align='left' colspan='${cols-4}'>&nbsp;</td>
	        </tr>
