...
<table width="100%" height="100%" border="0" cellpadding="0"
	...
	<tr>
		...
		<td height="608"
			background="<%=request.getContextPath()%>/exedo/webv3/images/login/login_03.gif">
		<table width="862" border="0" align="center" cellpadding="0"
			...
			<tr>
				...
				<td height="266"
					background="<%=request.getContextPath()%>/exedo/webv3/images/login/login_04.gif"></td>
				...
				<table width="100%" border="0" cellspacing="0" cellpadding="0">
					...
					<tr>
						...
						<td width="424" height="95"
							background="<%=request.getContextPath()%>/exedo/webv3/images/login/login_06.gif"></td>

						<td width="183"
							background="<%=request.getContextPath()%>/exedo/webv3/images/login/login_07.gif">
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
						...
						<td width="255"
							background="<%=request.getContextPath()%>/exedo/webv3/images/login/login_08.gif"></td>
			...
			<tr>
				...
				<td height="247" valign="top"
					background="<%=request.getContextPath()%>/exedo/webv3/images/login/login_09.gif">
				<table width="100%" border="0" cellspacing="0" cellpadding="0">
