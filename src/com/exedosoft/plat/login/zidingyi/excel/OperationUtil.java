...
public class OperationUtil {
	...
	*/
	public static String round(double v, int scale) {
	   ...
	   if(result != null) {
		   String strDou = result.toString();
		   int len = strDou.length() - strDou.indexOf(".") - 1;
		   System.out.println(len);
		   if( len == 1) {
			   strresult = result.toString() + "0";
		   } else {
...
//		String strs = OperationUtil.FegefuZheng("as/dfa///sdf////asd//asdf\\\\sadf\\\\asdf\\\\\\\\\\\\\\asdf/sad\\fasdf");
		String d = OperationUtil.round(-2.22000, 2);
		System.out.println(d);
		
		
		int days = OperationUtil.getMonthDay(1997, 1);
