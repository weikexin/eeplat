...
public class WLogBuzhuTongjiDept extends DOAbstractAction {
					...
					if (emp_uid != null && !"".equals(emp_uid.trim())) {
						...
						while (rs != null && rs.next()) {
							...
							if (cal.get(Calendar.DAY_OF_MONTH) == day) {
								...
								if (day == 1) {
									String[] str = WLogBuzhuTongjiUtil
											.getCw_type(emp_uid,
													format.format(wdate));
									// 更新 cw_type 和 waddress
									cw_type = str[0];
						...
						if(ifappstatus) {
							...
							if (intNowYear == intYear && intNowMonth == intMonth) {
								...
								if (intNowDay > day - 1) {
									...
									long time = nowDate.getTime() + 24 * 60 * 60
											* 1000L;
