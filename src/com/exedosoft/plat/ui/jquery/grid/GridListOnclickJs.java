 ...
 * @author aa
 */
public class GridListOnclickJs extends DOViewTemplate {

	private static Log log = LogFactory.getLog(GridListOnclickJs.class);

	public GridListOnclickJs() {
		this.templateFile = "grid/GridListOnclickJs.ftl";
	}
