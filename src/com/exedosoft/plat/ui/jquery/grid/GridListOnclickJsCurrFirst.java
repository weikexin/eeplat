 ...
 * @author aa
 */
public class GridListOnclickJsCurrFirst extends DOViewTemplate {

	private static Log log = LogFactory.getLog(GridListOnclickJsCurrFirst.class);

	public GridListOnclickJsCurrFirst() {
		this.templateFile = "grid/GridListOnclickJsCurrFirst.ftl";
	}
