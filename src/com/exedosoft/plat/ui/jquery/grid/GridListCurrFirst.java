 ...
 * @author aa
 */
public class GridListCurrFirst extends DOViewTemplate {

	private static Log log = LogFactory.getLog(GridListCurrFirst.class);

	public GridListCurrFirst() {
		this.templateFile = "grid/GridListCurrFirst.ftl";
	}
