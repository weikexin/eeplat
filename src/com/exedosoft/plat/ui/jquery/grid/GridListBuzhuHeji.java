 ...
 * @author aa
 */
public class GridListBuzhuHeji extends DOViewTemplate {

	private static Log log = LogFactory.getLog(GridListBuzhuHeji.class);

	public GridListBuzhuHeji() {
		this.templateFile = "grid/GridListBuzhuHeji.ftl";
	}
