 ...
 * @author aa
 */
public class GridListTopView extends DOViewTemplate {

	private static Log log = LogFactory.getLog(GridListTopView.class);

	public GridListTopView() {
		this.templateFile = "grid/GridListTopView.ftl";
	}
