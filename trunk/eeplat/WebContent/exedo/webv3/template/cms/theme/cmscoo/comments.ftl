...
<!-- 准备加入评论权限功能
 <?php else : // this is displayed if there are no comments so far ?>
	...
	<div class="author">欢迎你， ${get_user_info().userinfo.user_nicename}.<a href="${bloginfo('site_url')}/theme/test/index.ftl?action=logoff" title="Log out of this account"> 点击退出系统 &raquo;</a></div>
