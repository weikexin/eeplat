...
;
CREATE OR REPLACE VIEW WF_YB AS
SELECT DISTINCT
 ...
 CREATE OR REPLACE VIEW WF_BJ AS
SELECT DISTINCT    wfi_desc,startuser,starttime,ni.objuid as contextNiUid,wpi.OBJUID AS contextPIUid, wpi.curState, wpi.instance_uid, ni.performeruid as USER_UID,nodeDate
